 ...
 * @author HACKER
 */
public class wardLogs extends JPanel {
    ...
    private static JLabel wardLogs;
    ...
    public wardLogs(){
        ...
        wardLogs.setForeground(Color.WHITE);
    ...
    private static JTable createView() {
        try {
            ...
            ResultSet resultSet = stmt.executeQuery("SELECT * FROM wardLogs;");
