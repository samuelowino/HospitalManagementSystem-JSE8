 ...
 * @author HACKER
 */
public class LabRequestLogs extends JPanel {
    ...
    public LabRequestLogs(){
        ...
        patientRecordsLabel = new JLabel("Lab Request Logs:");
    ...
    private static JTable createView() {
        try {
            ...
            ResultSet resultSet = stmt.executeQuery("select * from labrequestform;");
